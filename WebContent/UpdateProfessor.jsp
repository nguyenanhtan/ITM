...
<p id="msg"></p>
<a href="TeacherManager.jsp">Back</a>
...
function updateProfessor(){
	var name = "<%=request.getParameter("professor_name")%>";
	name = encodeURIComponent(name);
	var id = "<%=request.getParameter("professor_id")%>";
...
function handleUpdateProfessor(){
	document.getElementById("msg").innerHTML="Update teacher successfully";
}
</script>
</body>
</html>