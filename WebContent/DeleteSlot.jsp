...
<title>Delete Exist Slot</title>
</head>
<body onload="deleteSlot()">
<%
...
<p id="msg"></p>
<a href="SlotsManager.jsp">Back</a>
...
function deleteSlot(){
	...
	if(xmlhttp){
	   ...
	   //	alert(xmlStr);
	    ...
	    //alert("POST OK");
	    xmlhttp.onreadystatechange  = handleDeleteSlot;
...
function handleDeleteSlot(){
	document.getElementById("msg").innerHTML="Remove Slot successfully";
}
</script>
</body>
</html>