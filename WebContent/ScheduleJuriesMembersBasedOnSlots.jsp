...
Ho va ten hoc vien: <select name="student" id="select-student" class="select-box min-width-140" onchange="changeSelectStudent()">
	</select>
...
Loc theo: <select name="filter-by" id="filter-by" onchange="changeSelectDepartement()"></select><select id="filter-by-students"></select>
...
<td>
	GV huong dan
	<input type="button" value="S" onclick="sortJurySupervisor()">
	
</td>
<td>
	Phan bien 1
	<input type="button" value="S" onclick="sortJuryExaminer1()">
	<input type="button" value="R" onclick="resetExaminer1()">
</td>
<td>
	Phan bien 2
	<input type="button" value="S" onclick="sortJuryExaminer2()">
	<input type="button" value="R" onclick="resetExaminer2()">
</td>

<td>
	Chu tich
	<input type="button" value="S" onclick="sortJuryPresident()">
	<input type="button" value="R" onclick="resetPresident()">
</td>

<td>
	Thu ky
	<input type="button" value="S" onclick="sortJurySecretary()">
	<input type="button" value="R" onclick="resetSecretary()">
</td>

<td>
	Uy vien
	<input type="button" value="S" onclick="sortJuryAdditionalMember()">
	<input type="button" value="R" onclick="resetAdditionalMember()">
</td>

<td>
	Kip
	<input type="button" value="S" onclick="sortJurySlot()">
	<input type="button" value="R" onclick="resetSlots()">
</td>
<td>
	Phong
	<input type="button" value="S" onclick="sortJuryRoom()">
	<input type="button" value="R" onclick="resetRooms()">
</td>
...
So phong <input type="text" id="nbr-juries" name="nbr-juries" value="0">
</tr>
...
Theo: <select name="balance" id="balance">
<option value="examiner1">Phan bien 1</option>
<option value="examiner2">Phan bien 2</option>
</select>
	...
	if(xmlhttp.readyState == 4){
		if(xmlhttp.status == 200){
			...
			for(i = 0; i < students.length; i++){
				...
				var sname = students[i].getElementsByTagName("name")[0].firstChild.nodeValue;
...
function handleChangeSelectDepartmentTeacher(){
	if(xmlhttp.readyState == 4){
		if(xmlhttp.status == 200){
			...
			var selFilterByTeacher = document.getElementById("jury-members");
...
function loadJuryList(){
	if(xmlhttp){
	   ...
	   xmlStr += "<FilterByStudents>" + document.getElementById("filter-by-students").value + "</FilterByStudents>\n";
	   xmlStr += "<session>" + document.getElementById("select-defense-session").value +  "</session>";
...
function handleLoadJury(){
	if(xmlhttp.readyState == 4){
		if(xmlhttp.status == 200){
			...
			/*
			var slots = xmlData.getElementsByTagName("slot");
			...
			for(i = 0; i < slots.length; i++){
				...
				var slotName = slots[i].getElementsByTagName("name")[0].firstChild.nodeValue;
				addRowSlot(table_slots,slotId, slotName);
			}
			
			var rooms = xmlData.getElementsByTagName("Rooms")[0].getElementsByTagName("room");
			//alert("rooms.sz = " + rooms.length);
			...
			*/
			...
			//alert("Slots.sz = " + slots.length + ", rooms.sz = " + rooms.length);
