...
<body onload="deleteSubjectCategory()">
<%
...
<p id="msg"></p>
<a href="SubjectCategoriesManager.jsp">Back</a>
...
function deleteSubjectCategory(){
	...
	if(xmlhttp){
	   ...
	   xmlStr += "<id>" + id + "</id>";
	   xmlStr += "</DeleteSubjectCategory>";
	   //	alert(xmlStr);
	    xmlhttp.open("POST","TeacherManager",true); //getname will be the servlet name
	    //alert("POST OK");
	    xmlhttp.onreadystatechange  = handleDeleteSubjectCategory;
...
function handleDeleteSubjectCategory(){
	document.getElementById("msg").innerHTML="Remove Class successfully";
}
</script>
</body>
</html>