...
So hoi dong <input type="text" id="nbr-juries" name="nbr-juries" value="0">
</tr>

<input type="button" value="Reset giang vien da duoc chon" onclick="resetSelectedMembers()">
<input type="button" value="Reset kip" onclick="resetSlots()">
<input type="button" value="Reset phong" onclick="resetRooms()">
<input type="button" value="Reset giang vien tung hoi dong" onclick="resetScheduleMembers()">
...
<option value="AssignPresidentRoom">Xep chu tich cho cac phong</option>
...
<option value="BackTrackSearchAssignTeachersSlotsRooms">BackTrackSearchAssignTeachersSlotsRooms</option>
...
<input type="button" value="Reset Phong" onclick="resetRoomInfo()">
<input type="button" value="Them Phong" onclick="increaseRoomInfo()">
<input type="button" value="Giam Phong" onclick="decreaseRoomInfo()">
<table id="list-slots">
<tr>
